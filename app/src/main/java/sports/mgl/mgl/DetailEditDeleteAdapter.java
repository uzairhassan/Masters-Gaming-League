...
public class DetailEditDeleteAdapter extends BaseAdapter {
    private final LayoutInflater mInflater;
    private ArrayList<Schedule> matches;
    private Context context;

    public DetailEditDeleteAdapter(Context context,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.listview_detail_edit_delete, null);
            holder = new Holder();
